console.log("OPENAI_API_KEY:", process.env.OPENAI_API_KEY);  // <- This must log your key
...
export default async function handler(req, res) {
  ...
  // Compose your prompt for DALL·E
  const fullPrompt = `
